...
export class KeypairChallengeConsumed1777561204579 implements MigrationInterface {
    name = 'KeypairChallengeConsumed1777561204579'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "keypair_challenge" ADD "consumed_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "keypair_challenge" ADD "consumed_by_credential_id" integer`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "keypair_challenge" DROP COLUMN "consumed_by_credential_id"`);
        await queryRunner.query(`ALTER TABLE "keypair_challenge" DROP COLUMN "consumed_at"`);
